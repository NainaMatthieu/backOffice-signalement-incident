        ...
        login: function(admin, $scope){
            ...
            validate.then(function(response){
                ...
                if(user){
                    ...
                    window.location.replace("https://projet-signalement-incident.herokuapp.com/#/home");
                }
                    ...
                    window.location.replace("https://projet-signalement-incident.herokuapp.com/login.html");
                }
            });
        },
        logout: function(){
